...
var openid = {
  ...
  useInputBox: function (provider) {
    var input_box = $('#openid_username');
    var input_label = $('#openid_label');

    if (provider['label']) {
      input_label.html(provider['label']);
      $('#openid_input_area').show();
      input_box.val('');
      input_box.focus();
    }
    else {
      // username isn't in the url, so don't display it
